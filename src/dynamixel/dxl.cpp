...
#define INST_PING      (1) //No execution. It is used when controller is ready to receive Status Packet
#define INST_READ      (2) //This command reads data from Dynamixel
#define INST_WRITE     (3) //This command writes data to Dynamixel
#define INST_REG_WRITE (4) //It is similar to WRITE, but it remains in the standby state without being executed until the ACTION command arrives.
#define INST_ACTION    (5) //This command initiates motions registered with REG WRITE
#define INST_RESET     (6) //This command restores the state of Dynamixel to the factory default setting.
